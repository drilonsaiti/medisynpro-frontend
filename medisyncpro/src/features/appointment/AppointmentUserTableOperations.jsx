...
const AccommodationTableOperations = ({types}) => {
    ...
    const allSpecializations = Array.isArray(specializations)
        ? specializations.sort((a, b) => a.specializationId - b.specializationId)
        : [];
    ...
    return (
        <TableOperations>
            ...
            <SortBy type="checkbox" filterField='discount' options={options} types={types}/>
